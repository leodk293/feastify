...
function MealsContent() {
    ...
    async function fetchMealsByIngredients() {
    ...
    return (
        <main className="flex flex-col items-center mx-3 md:mx-0">
            <div className='flex flex-col gap-1'>
                <h1 className="text-xl font-extrabold text-red-950 mt-10 md:text-3xl">
                    Results for meals containing &apos;{ingredientName}&apos; as an ingredient
                </h1>
            ...
            {ingredients.loading ? (
                ...
                <p className="text-orange-800 text-2xl font-bold mt-[60px] md:h-[10rem]">
                    No results found for {ingredientName}.
                </p>
            )}
        </main>
    );
